    ...
    def __init__(self, master, id=None):
        if id is not None:
            ...
            self.acursor.execute(
                f"select p.name, p.nation,p.DOB, p.team, m.hiredate, m.joindate from manager m, participant p where m.mid = p.pid and p.name='{self.mname}'")
            ...
            # create fields
            Label(self.managerStat_frame, text="Name: ", font=font, borderwidth=3, relief="ridge").grid(
                row=0, column=0, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text="Nationality: ", font=font, borderwidth=3,
                  relief="ridge").grid(row=1, column=0, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text="Born on: ", font=font, borderwidth=3,
                  relief="ridge").grid(
                row=2, column=0, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text="Belongs to: ", font=font, borderwidth=3,
                  relief="ridge").grid(row=3, column=0, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text="Hire date: ", font=font, borderwidth=3,
                  relief="ridge").grid(row=4, column=0, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text="Join date: ", font=font, borderwidth=3,
                  relief="ridge").grid(row=5, column=0, sticky=EW, ipadx=10, ipady=5)

            # fill the details
            Label(self.managerStat_frame, text=self.player[0], font=font, borderwidth=3, relief="ridge").grid(
                row=0, column=1, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text=self.player[1], font=font, borderwidth=3, relief="ridge").grid(
                row=1, column=1, sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text=self.player[2].date(), font=font, borderwidth=3,
                  relief="ridge").grid(row=2,
                                       column=1,
                                       sticky=EW, ipadx=10, ipady=5)
            Label(self.managerStat_frame, text=self.player[3], font=font, borderwidth=3,
            ...
            self.managerStat_frame.place(x=700, y=225)
