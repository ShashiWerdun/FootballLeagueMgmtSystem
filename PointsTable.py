...
class pointsTableFrame(template):
    ...
    def __init__(self, master):
        ...
        self.style.configure("Treeview", background="cornsilk3", foreground="black", rowheight=25,
          ...
          self.my_tree['columns'] = ("Position", "Team", "Played", "Wins", "Draws", "Loss", "GF (Goals For)", "GA (Goals Against)", "GD (Goals Diff)", "Points")
          ...
          for record in self.data:
                self.my_tree.insert(parent='', index='end', iid=self.count, text="", values=(record[0], record[1], record[2], record[3], record[4], record[5], record[6], record[7], record[8], record[9]))
                self.count += 1
